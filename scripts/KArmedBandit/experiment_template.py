...
CONFIG.K = 10
CONFIG.num_train_tasks = 100
CONFIG.num_test_tasks = 100
CONFIG.T_train = 100
CONFIG.T_test = 100
CONFIG.seq_len = 100

CONFIG.model_type = "ARConcatTransformer"  # ARConcatTransformer, ARAddTransformer, ARMultiplyTransformer
CONFIG.d_model = 64
CONFIG.nhead = 4
CONFIG.num_layers = 4
...
run_name: str = f"{CONFIG.model_type}"
